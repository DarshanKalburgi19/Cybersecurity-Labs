...
## Sensitive Data Exposure via Authorization Bypass in Redirect Response
...
Send the request and inspect the response body.
...
The response contains carlos’ sensitive account data, including his API key, even though the application attempts to redirect the user afterward.
