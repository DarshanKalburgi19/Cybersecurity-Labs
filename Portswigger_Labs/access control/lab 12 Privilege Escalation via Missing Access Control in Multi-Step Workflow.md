# Lab 12: Privilege Escalation via Missing Access Control in Multi-Step Workflow
...
2. Intercept a role-change confirmation request:
   `POST /admin-roles`
   `action=upgrade&confirmed=true&username=carlos`
3. Modify the `username` parameter to target your own account:
