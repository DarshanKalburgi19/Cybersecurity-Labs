...
Intercept a request to the application’s home page using Burp Suite.



Modify the request to include the following header:
...
Observe that the response returns 200 OK and renders the administrative interface, despite the user being unauthenticated.



Inspect the admin panel source and identify a deletion endpoint:
